...
print("It differs from the value when using integer division as the integer division does not give us the decimal values.")
...
print(remEven)
print(remOdd)
print("Yes, the remainder operator can be used to determine if an integer is even or odd")
/*:
