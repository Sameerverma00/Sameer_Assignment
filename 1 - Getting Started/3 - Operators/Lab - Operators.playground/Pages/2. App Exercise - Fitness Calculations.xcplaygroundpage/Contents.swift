...
print(averageHRD)
print("Yes, this differs from our previous average as previously we used 'Int' type and in the later section, we have used 'Double' type, so it shows us the decimal point aswell. ")
