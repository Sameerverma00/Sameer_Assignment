 ...
 */
var walkingChallenges : [String] = ["Walk 3 miles a day", "Walk 30 miles in a month"]
var runChallenges : [String] = [ "Run 5 times a week.",  "Run 10 times in month."]
...
var challenges  = [walkingChallenges,runChallenges]
