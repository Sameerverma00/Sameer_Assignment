...
print("the Latitude is \(somePlace.latitude) and the Longitude is \(somePlace.longitude)")
...
var favoriteBook = Book(title: "Harry Potter", author: "J. K. Rowling", pages: 123, price: 1534.50)
...
//var lapiiii = Laptop(yearPurchasedn: 2018) // here it is default Initializers
var laptop1 = Laptop(screenSize: 13,repairCount : 2, yearPurchased : 2007 )
var laptop2 = Laptop(screenSize: 15,repairCount : 2, yearPurchased : 2007 )
print(laptop1)
print(laptop2)
...
var heightInches = Height(heightInInches: 1)
